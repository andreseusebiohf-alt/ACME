...
public class quizprima extends Fragment {
    ...
    public void elegirquiz(){
        switch (quest){
            case 1:
                ...
                preguntastxt= "nivel prima/PMatematicas.txt";
                respuestastxt= "nivel prima/RMatematicas.txt";
                break;
            case 2:
                keyobjeto="Geo";
                quizelegido="Quiz Geografia";
                preguntastxt= "nivel prima/PGeografia.txt";
                respuestastxt= "nivel prima/RGeografia.txt";
                break;
            case 3:
                keyobjeto="Ing";
                quizelegido="Quiz Ingles";
                preguntastxt= "nivel prima/PIngles.txt";
                respuestastxt= "nivel prima/RIngles.txt";
                break;
            case 4:
                keyobjeto="HU";
                quizelegido="Quiz HistoriaUniversal";
                preguntastxt= "nivel prima/PHistoriaUniversal.txt";
                respuestastxt= "nivel prima/RHistoriaUniversal.txt";
                break;
            case 5:
                keyobjeto="CP";
                quizelegido="Quiz CulturaPopular";
                preguntastxt= "nivel prima/PCulturaPopular.txt";
                respuestastxt= "nivel prima/RCulturaPopular.txt";
                break;
            case 6:
                keyobjeto="Gra";
                quizelegido="Quiz Gramatica";
                preguntastxt= "nivel prima/PGramatica.txt";
                respuestastxt= "nivel prima/RGramatica.txt";
                break;
            case 7:
                keyobjeto="CN";
                quizelegido="Quiz CienciasNaturales";
                preguntastxt= "nivel prima/PCienciasNaturales.txt";
                respuestastxt= "nivel prima/RCienciasNaturales.txt";
                break;
            case 8:
                keyobjeto="Dep";
                quizelegido="Quiz Deportes";
                preguntastxt= "nivel prima/PDeportes.txt";
                respuestastxt= "nivel prima/RDeportes.txt";
                break;
        }
        cargarespuestas();
        inicio();
