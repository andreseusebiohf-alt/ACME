...
public class quizprepa extends Fragment {
    ...
    public void elegirquiz(){
        switch (quest){
            case 1:
                ...
                preguntastxt= "nivel prepa/PMatematicas.txt";
                respuestastxt= "nivel prepa/RMatematicas.txt";
                break;
            case 2:
                keyobjeto="Geo";
                quizelegido="Quiz Geografia";
                preguntastxt= "nivel prepa/PGeografia.txt";
                respuestastxt= "nivel prepa/RGeografia.txt";
                break;
            case 3:
                keyobjeto="Ing";
                quizelegido="Quiz Ingles";
                preguntastxt= "nivel prepa/PIngles.txt";
                respuestastxt= "nivel prepa/RIngles.txt";
                break;
            case 4:
                keyobjeto="HU";
                quizelegido="Quiz HistoriaUniversal";
                preguntastxt= "nivel prepa/PHistoriaUniversal.txt";
                respuestastxt= "nivel prepa/RHistoriaUniversal.txt";
                break;
            case 5:
                keyobjeto="CP";
                quizelegido="Quiz CulturaPopular";
                preguntastxt= "nivel prepa/PCulturaPopular.txt";
                respuestastxt= "nivel prepa/RCulturaPopular.txt";
                break;
            case 6:
                keyobjeto="Gra";
                quizelegido="Quiz Gramatica";
                preguntastxt= "nivel prepa/PGramatica.txt";
                respuestastxt= "nivel prepa/RGramatica.txt";
                break;
            case 7:
                keyobjeto="CN";
                quizelegido="Quiz CienciasNaturales";
                preguntastxt= "nivel prepa/PCienciasNaturales.txt";
                respuestastxt= "nivel prepa/RCienciasNaturales.txt";
                break;
            case 8:
                keyobjeto="Dep";
                quizelegido="Quiz Deportes";
                preguntastxt= "nivel prepa/PDeportes.txt";
                respuestastxt= "nivel prepa/RDeportes.txt";
                break;
        }
        cargarespuestas();
        inicio();
