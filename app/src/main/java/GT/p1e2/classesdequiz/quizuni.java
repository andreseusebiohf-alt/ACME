...
public class quizuni extends Fragment {
    ...
    public void elegirquiz(){
        switch (quest){
            case 1:
                ...
                preguntastxt= "nivel uni/PMatematicas.txt";
                respuestastxt= "nivel uni/RMatematicas.txt";
                break;
            case 2:
                keyobjeto="Geo";
                quizelegido="Quiz Geografia";
                preguntastxt= "nivel uni/PGeografia.txt";
                respuestastxt= "nivel uni/RGeografia.txt";
                break;
            case 3:
                keyobjeto="Ing";
                quizelegido="Quiz Ingles";
                preguntastxt= "nivel uni/PIngles.txt";
                respuestastxt= "nivel uni/RIngles.txt";
                break;
            case 4:
                keyobjeto="HU";
                quizelegido="Quiz HistoriaUniversal";
                preguntastxt= "nivel uni/PHistoriaUniversal.txt";
                respuestastxt= "nivel uni/RHistoriaUniversal.txt";
                break;
            case 5:
                keyobjeto="CP";
                quizelegido="Quiz CulturaPopular";
                preguntastxt= "nivel uni/PCulturaPopular.txt";
                respuestastxt= "nivel uni/RCulturaPopular.txt";
                break;
            case 6:
                keyobjeto="Gra";
                quizelegido="Quiz Gramatica";
                preguntastxt= "nivel uni/PGramatica.txt";
                respuestastxt= "nivel uni/RGramatica.txt";
                break;
            case 7:
                keyobjeto="CN";
                quizelegido="Quiz CienciasNaturales";
                preguntastxt= "nivel uni/PCienciasNaturales.txt";
                respuestastxt= "nivel uni/RCienciasNaturales.txt";
                break;
            case 8:
                keyobjeto="Dep";
                quizelegido="Quiz Deportes";
                preguntastxt= "nivel uni/PDeportes.txt";
                respuestastxt= "nivel uni/RDeportes.txt";
                break;
        }
        cargarespuestas();
        inicio();
